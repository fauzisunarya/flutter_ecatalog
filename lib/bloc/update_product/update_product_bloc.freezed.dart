...
class __$$_DoUpdateCopyWithImpl<$Res>
  ...
  __$$_DoUpdateCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_DoUpdate));

  @override
  _$_DoUpdate get _value => super._value as _$_DoUpdate;
...
class _$_DoUpdate implements _DoUpdate {
  const _$_DoUpdate({required this.requestData});
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(requestData));
...
abstract class _DoUpdate implements UpdateProductEvent {
  const factory _DoUpdate({required final ProductRequestModel requestData}) =
      _$_DoUpdate;
